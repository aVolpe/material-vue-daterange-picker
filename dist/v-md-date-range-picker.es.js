...
/* template */
var __vue_render__$2 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-text-field',{attrs:{"label":_vm.title,"readonly":""},model:{value:(_vm.value),callback:function ($$v) {_vm.value=$$v;},expression:"value"}})};
...
/* template */
var __vue_render__$3 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"clickoutside",rawName:"v-clickoutside",value:(_vm.clickOutside),expression:"clickOutside"}],staticClass:"mdrp-root"},[_c('div',{staticClass:"mdrp__activator",on:{"click":_vm.togglePicker}},[_vm._t("input",[_c('default-activator',{ref:"defaultActivator",attrs:{"value":(_vm.startText + " - " + _vm.endText),"readonly":"","title":_vm.locale.activatorTitle}})])],2),_vm._v(" "),_c('transition',{attrs:{"name":"slide-fade","mode":"out-in"}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.pickerVisible),expression:"pickerVisible"}],staticClass:"mdrp__panel dropdown-menu",class:_vm.pickerStyles()},[(_vm.showPresets && _vm.presets)?_c('calendar-ranges',{attrs:{"canSelect":_vm.inRange,"presets":_vm.presets},on:{"clickCancel":function($event){_vm.pickerVisible = false;},"clickApply":_vm.clickApply,"clickPreset":_vm.clickPreset}}):_vm._e(),_vm._v(" "),_c('calendar',{staticClass:"calendar left",attrs:{"location":"left","calendar-month":_vm.leftCalendarMonth_,"locale":_vm.locale,"start":_vm.start_,"end":_vm.end_,"hover-start":_vm.hoverStart_,"hover-end":_vm.hoverEnd_},on:{"clickNextMonth":_vm.clickNextMonth,"clickPrevMonth":_vm.clickPrevMonth,"dateClick":_vm.dateClick,"hoverDate":_vm.hoverDate,"clickYearSelect":_vm.clickYearSelect}}),_vm._v(" "),_c('calendar',{staticClass:"calendar right",attrs:{"location":"right","calendar-month":_vm.rightCalendarMonth_,"locale":_vm.locale,"start":_vm.start_,"end":_vm.end_,"hover-start":_vm.hoverStart_,"hover-end":_vm.hoverEnd_},on:{"clickNextMonth":_vm.clickNextMonth,"clickPrevMonth":_vm.clickPrevMonth,"dateClick":_vm.dateClick,"hoverDate":_vm.hoverDate,"clickYearSelect":_vm.clickYearSelect}})],1)])],1)};
var __vue_staticRenderFns__$3 = [];

  /* style */
  const __vue_inject_styles__$3 = function (inject) {
    if (!inject) return
    inject("data-v-8683702c_0", { source: "@charset \"UTF-8\";*[data-v-8683702c]{box-sizing:border-box}.mdrp__panel.opens-arrow-pos-center[data-v-8683702c]::after,.mdrp__panel.opens-arrow-pos-center[data-v-8683702c]::before{left:0;right:0;width:0;margin-left:auto;margin-right:auto}.mdrp-root[data-v-8683702c]{position:relative;display:inline-block;width:100%;padding-right:20px}.mdrp__panel[data-v-8683702c]{font-size:15px;line-height:1em;position:absolute;z-index:3001;top:100px;left:20px;width:278px;max-width:none;margin-top:7px;padding:0;color:inherit;border:1px solid #ddd;border-radius:4px;background-color:#fff}.mdrp__panel.show-calendar[data-v-8683702c]{display:block}.mdrp__panel[data-v-8683702c]::after,.mdrp__panel[data-v-8683702c]::before{position:absolute;display:inline-block;border-bottom-color:red;content:\"\"}.mdrp__panel[data-v-8683702c]::before{top:-7px;border-right:7px solid transparent;border-bottom:7px solid #ccc;border-left:7px solid transparent}.mdrp__panel[data-v-8683702c]::after{top:-6px;border-right:6px solid transparent;border-bottom:6px solid #fff;border-left:6px solid transparent}.mdrp__panel.opens-arrow-pos-left[data-v-8683702c]{top:40px;left:10px;right:auto}.mdrp__panel.opens-arrow-pos-left[data-v-8683702c]::before{left:9px}.mdrp__panel.opens-arrow-pos-left[data-v-8683702c]::after{left:10px}.mdrp__panel.opens-arrow-pos-right[data-v-8683702c]{top:40px;right:10px;left:auto}.mdrp__panel.opens-arrow-pos-right[data-v-8683702c]::before{right:9px}.mdrp__panel.opens-arrow-pos-right[data-v-8683702c]::after{right:10px}.mdrp__panel.opens-arrow-pos-center[data-v-8683702c]{top:40px}.mdrp__panel.dropdown-menu[data-v-8683702c]{max-width:none;z-index:9}.mdrp__panel .calendar-table[data-v-8683702c]{display:none;max-width:270px}.mdrp__panel.show-calendar .calendar-table[data-v-8683702c]{display:block}@media (min-width:564px){.mdrp__panel[data-v-8683702c]{width:auto}.mdrp__panel.show-calendar[data-v-8683702c]{display:inline-flex}.mdrp__panel .calendar-table.left[data-v-8683702c]{padding:8px 0 8px 8px}.mdrp__panel .calendar-table.right[data-v-8683702c]{padding:8px}}.slide-fade-enter-active[data-v-8683702c]{transition:all .2s ease}.slide-fade-leave-active[data-v-8683702c]{transition:all .1s cubic-bezier(1,.5,.8,1)}.slide-fade-enter[data-v-8683702c],.slide-fade-leave-to[data-v-8683702c]{transform:translateX(10px);opacity:0}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$3 = "data-v-8683702c";
  /* module identifier */
